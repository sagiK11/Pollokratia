...
class _CreateMissionState extends State<CreateMission> {
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () async {
                        ...
                        MissionCard newMission = new MissionCard(
                            ...
                            forArticleOpinion:
                                _forArticleOpinion.text.toString(),
                            againstArticleOpinion:
                                _againstArticleOpinion.text.toString(),
                            positiveVotes: "0",
                            negativeVotes: "0",
                            checkBoxValue: "false",
                            key: id);
                        //Get reference to the path we'll add the new mission.
                        var ref = databaseReference.child("Missions");
  ...
  bool invalidInput() {
    ...
    if (_descriptionController.text.toString().length <
    ...
    if (_againstArticleOpinion.text.toString().length <
        MIN_AGAIN_ARTICLE_LENGTH) {
      _showAlertDialog(context, AppLocalizations.of(context).translate("against_article_err"), true);
      return true;
    }
    return false;
  }
  ...
  Future<void> _showAlertDialog(
      BuildContext context, String alert, bool error) {
          ...
          return AlertDialog(
            actions: [
              FlatButton(
                ...
                child: Text(
                    error ? AppLocalizations.of(context).translate("mission_error") :AppLocalizations.of(context).translate("lets_see_mission")),
              ),
            ],
